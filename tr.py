...
class Notepad: 
        ...
        def __init__(self,**kwargs): 
                ...
                #to create a feature of font
                self.__thisFontMenu.add_command(label="Verdana", command=self.__changeFont)
        ...
        #function to change font to "Verdana". Extend logic for other fonts accordingly.
        #Also for multiple fonts use delete tags to remove the tags applied by previous fonts
        ...
        def __changeFont(self):
                ...
                try:
                        ...
                        self.__thisTextArea.tag_configure("Verdana",font=self.bold_font)
                        print ("Font chagned")
